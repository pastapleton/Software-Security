...
const char *CkCrypt2_encodedIV(HCkCrypt2 cHandle, const char *encoding);
const char *CkCrypt2_encodedKey(HCkCrypt2 cHandle, const char *encoding);
const char *CkCrypt2_encodedSalt(HCkCrypt2 cHandle, const char *encoding);
...
const char *CkCrypt2_signatureSigningTimeStr(HCkCrypt2 cHandle, int index);
