...
BOOL CkCsv_GetCellByName(HCkCsv cHandle, int row, const char *columnName, HCkString outStr);
...
BOOL CkCsv_RowMatches(HCkCsv cHandle, int row, const char *matchPattern, BOOL bCaseSensitive);
...
BOOL CkCsv_SetCellByName(HCkCsv cHandle, int row, const char *columnName, const char *content);
BOOL CkCsv_SetColumnName(HCkCsv cHandle, int index, const char *columnName);
BOOL CkCsv_SortByColumn(HCkCsv cHandle, const char *columnName, BOOL bAscending, BOOL bCaseSensitive);
const char *CkCsv_cell(HCkCsv cHandle, int row, int col);
const char *CkCsv_cellByName(HCkCsv cHandle, int row, const char *columnName);
const char *CkCsv_columnName(HCkCsv cHandle, int index);
...
const char *CkCsv_getCellByName(HCkCsv cHandle, int row, const char *columnName);
