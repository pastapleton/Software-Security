...
class CkSshW : public CkWideCharBase
{
	...
	CkSshProgress *get_EventCallbackObjectA(void) const;
	void put_EventCallbackObjectA(CkSshProgress *progress);
...
const wchar_t *receivedText(int channelNum,const wchar_t *w1);
const wchar_t *receivedTextS(int channelNum,const wchar_t *w1,const wchar_t *w2);
