...
HCkPrivateKeyW CkPrivateKeyW_Create2(BOOL bForDso);
...
const wchar_t *CkPrivateKeyW__pkcs8EncryptedPem(HCkPrivateKeyW cHandle, const wchar_t *password);
const wchar_t *CkPrivateKeyW__pkcs8Pem(HCkPrivateKeyW cHandle);
const wchar_t *CkPrivateKeyW__rsaPem(HCkPrivateKeyW cHandle);
const wchar_t *CkPrivateKeyW__version(HCkPrivateKeyW cHandle);
const wchar_t *CkPrivateKeyW__xml(HCkPrivateKeyW cHandle);
#endif
