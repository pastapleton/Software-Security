...
const char *CkRss_attr(HCkRss cHandle, const char *tag, const char *attrName);
const char *CkRss_dateStr(HCkRss cHandle, const char *tag);
...
const char *CkRss_string(HCkRss cHandle, const char *tag);
