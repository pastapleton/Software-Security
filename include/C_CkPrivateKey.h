...
const char *CkPrivateKey_pkcs8EncryptedPem(HCkPrivateKey cHandle, const char *password);
const char *CkPrivateKey_pkcs8Pem(HCkPrivateKey cHandle);
const char *CkPrivateKey_rsaPem(HCkPrivateKey cHandle);
const char *CkPrivateKey_version(HCkPrivateKey cHandle);
const char *CkPrivateKey_xml(HCkPrivateKey cHandle);
#endif
