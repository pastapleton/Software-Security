...
bool SetEncodedSignatureRS(const wchar_t *w1,const wchar_t *w2,const wchar_t *w3);
...
const wchar_t *encodedHash(const wchar_t *w1);
const wchar_t *encodedSignature(const wchar_t *w1);
