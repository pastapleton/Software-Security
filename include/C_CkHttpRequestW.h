...
HCkHttpRequestW CkHttpRequestW_Create2(BOOL bForDso);
...
const wchar_t *CkHttpRequestW__headerField(HCkHttpRequestW cHandle, const wchar_t *name);
const wchar_t *CkHttpRequestW__headerName(HCkHttpRequestW cHandle, int index);
const wchar_t *CkHttpRequestW__headerValue(HCkHttpRequestW cHandle, int index);
...
const wchar_t *CkHttpRequestW__param(HCkHttpRequestW cHandle, const wchar_t *name);
const wchar_t *CkHttpRequestW__paramName(HCkHttpRequestW cHandle, int index);
const wchar_t *CkHttpRequestW__paramValue(HCkHttpRequestW cHandle, int index);
const wchar_t *CkHttpRequestW__path(HCkHttpRequestW cHandle);
const wchar_t *CkHttpRequestW__urlEncodedParams(HCkHttpRequestW cHandle);
