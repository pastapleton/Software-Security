...
BOOL CkImap_StoreFlags(HCkImap cHandle, int msgId, BOOL bUid, const char *flagName, int value);
...
const char *CkImap_mailAttachFilename(HCkImap cHandle, HCkEmail email, int attachIndex);
