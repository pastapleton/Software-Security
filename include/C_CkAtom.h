...
const char *CkAtom_element(HCkAtom cHandle, const char *tag, int index);
const char *CkAtom_elementAttr(HCkAtom cHandle, const char *tag, int index, const char *attrName);
const char *CkAtom_elementDateStr(HCkAtom cHandle, const char *tag, int index);
...
const char *CkAtom_linkHref(HCkAtom cHandle, const char *relName);
const char *CkAtom_personInfo(HCkAtom cHandle, const char *tag, int index, const char *tag2);
const char *CkAtom_toXmlString(HCkAtom cHandle);
const char *CkAtom_topAttr(HCkAtom cHandle, const char *attrName);
