...
HCkSFtpW CkSFtpW_Create2(BOOL bForDso);
...
const wchar_t *CkSFtpW__fileCreateTimeStr(HCkSFtpW cHandle, const wchar_t *pathOrHandle, BOOL bFollowLinks, BOOL bIsHandle);
const wchar_t *CkSFtpW__fileGroup(HCkSFtpW cHandle, const wchar_t *filePathOrHandle, BOOL bFollowLinks, BOOL bIsHandle);
const wchar_t *CkSFtpW__fileLastAccessStr(HCkSFtpW cHandle, const wchar_t *pathOrHandle, BOOL bFollowLinks, BOOL bIsHandle);
const wchar_t *CkSFtpW__fileLastModifiedStr(HCkSFtpW cHandle, const wchar_t *pathOrHandle, BOOL bFollowLinks, BOOL bIsHandle);
const wchar_t *CkSFtpW__fileOwner(HCkSFtpW cHandle, const wchar_t *filePathOrHandle, BOOL bFollowLinks, BOOL bIsHandle);
const wchar_t *CkSFtpW__fileSizeStr(HCkSFtpW cHandle, const wchar_t *filePathOrHandle, BOOL bFollowLinks, BOOL bIsHandle);
