...
HCkPublicKeyW CkPublicKeyW_Create2(BOOL bForDso);
...
const wchar_t *CkPublicKeyW__openSslPem(HCkPublicKeyW cHandle);
const wchar_t *CkPublicKeyW__version(HCkPublicKeyW cHandle);
const wchar_t *CkPublicKeyW__xml(HCkPublicKeyW cHandle);
#endif
