...
HCkSocketW CkSocketW_Create2(BOOL bForDso);
...
BOOL CkSocketW_ReceiveBytesENC(HCkSocketW cHandle, const wchar_t *encodingAlg, HCkStringW outStr);
...
BOOL CkSocketW_ReceiveNBytesENC(HCkSocketW cHandle, unsigned long numBytes, const wchar_t *encodingAlg, HCkStringW outStr);
...
const wchar_t *CkSocketW__receiveBytesENC(HCkSocketW cHandle, const wchar_t *encodingAlg);
const wchar_t *CkSocketW__receiveNBytesENC(HCkSocketW cHandle, unsigned long numBytes, const wchar_t *encodingAlg);
...
const wchar_t *CkSocketW__sslAcceptableClientCaDn(HCkSocketW cHandle, int index);
