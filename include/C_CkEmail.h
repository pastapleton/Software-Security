...
BOOL CkEmail_GetAttachmentHeader(HCkEmail cHandle, int index, const char *fieldName, HCkString outFieldValue);
...
void CkEmail_RemoveAttachedMessage(HCkEmail cHandle, int index);
...
BOOL CkEmail_SaveAttachedFile(HCkEmail cHandle, int index, const char *directory);
BOOL CkEmail_SaveEml(HCkEmail cHandle, const char *path);
BOOL CkEmail_SaveLastError(HCkEmail cHandle, const char *path);
BOOL CkEmail_SaveRelatedItem(HCkEmail cHandle, int index, const char *directory);
...
const char *CkEmail_altHeaderField(HCkEmail cHandle, int index, const char *fieldName);
const char *CkEmail_alternativeBody(HCkEmail cHandle, int index);
const char *CkEmail_alternativeBodyByContentType(HCkEmail cHandle, const char *contentType);
const char *CkEmail_alternativeContentType(HCkEmail cHandle, int index);
const char *CkEmail_attachedMessageFilename(HCkEmail cHandle, int index);
const char *CkEmail_attachmentContentID(HCkEmail cHandle, int index);
const char *CkEmail_attachmentContentType(HCkEmail cHandle, int index);
const char *CkEmail_attachmentFilename(HCkEmail cHandle, int index);
const char *CkEmail_attachmentHeader(HCkEmail cHandle, int index, const char *fieldName);
const char *CkEmail_attachmentString(HCkEmail cHandle, int index, const char *charset);
const char *CkEmail_attachmentStringCrLf(HCkEmail cHandle, int index, const char *charset);
...
const char *CkEmail_bcc(HCkEmail cHandle, int index);
const char *CkEmail_bccAddr(HCkEmail cHandle, int index);
const char *CkEmail_bccName(HCkEmail cHandle, int index);
const char *CkEmail_body(HCkEmail cHandle);
const char *CkEmail_bounceAddress(HCkEmail cHandle);
const char *CkEmail_cC(HCkEmail cHandle, int index);
const char *CkEmail_ccAddr(HCkEmail cHandle, int index);
const char *CkEmail_ccName(HCkEmail cHandle, int index);
...
const char *CkEmail_deliveryStatusInfo(HCkEmail cHandle, const char *fieldName);
...
const char *CkEmail_getAttachmentHeader(HCkEmail cHandle, int index, const char *fieldName);
...
const char *CkEmail_headerField(HCkEmail cHandle, const char *fieldName);
const char *CkEmail_headerFieldName(HCkEmail cHandle, int index);
const char *CkEmail_headerFieldValue(HCkEmail cHandle, int index);
const char *CkEmail_htmlBody(HCkEmail cHandle);
...
const char *CkEmail_mime(HCkEmail cHandle);
const char *CkEmail_pkcs7CryptAlg(HCkEmail cHandle);
const char *CkEmail_plainTextBody(HCkEmail cHandle);
...
const char *CkEmail_relatedContentID(HCkEmail cHandle, int index);
const char *CkEmail_relatedContentLocation(HCkEmail cHandle, int index);
const char *CkEmail_relatedContentType(HCkEmail cHandle, int index);
const char *CkEmail_relatedFilename(HCkEmail cHandle, int index);
const char *CkEmail_relatedString(HCkEmail cHandle, int index, const char *charset);
const char *CkEmail_relatedStringCrLf(HCkEmail cHandle, int index, const char *charset);
const char *CkEmail_replacePattern(HCkEmail cHandle, int index);
const char *CkEmail_replaceString(HCkEmail cHandle, int index);
const char *CkEmail_replaceString2(HCkEmail cHandle, const char *pattern);
const char *CkEmail_replyTo(HCkEmail cHandle);
const char *CkEmail_report(HCkEmail cHandle, int index);
...
const char *CkEmail_to(HCkEmail cHandle, int index);
const char *CkEmail_toAddr(HCkEmail cHandle, int index);
const char *CkEmail_toName(HCkEmail cHandle, int index);
const char *CkEmail_uidl(HCkEmail cHandle);
const char *CkEmail_version(HCkEmail cHandle);
const char *CkEmail_xml(HCkEmail cHandle);
#endif
