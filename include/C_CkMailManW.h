...
HCkMailManW CkMailManW_Create2(BOOL bForDso);
...
HCkEmailW CkMailManW_FetchSingleHeader(HCkMailManW cHandle, int numBodyLines, int msgNum);
...
const wchar_t *CkMailManW__mailboxInfoXml(HCkMailManW cHandle);
#if defined(CK_MX_INCLUDED)
