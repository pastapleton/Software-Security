...
const char *CkHttp_cacheRoot(HCkHttp cHandle, int index);
...
const char *CkHttp_cookieXml(HCkHttp cHandle, const char *domain);
const char *CkHttp_debugLogFilePath(HCkHttp cHandle);
const char *CkHttp_domain(HCkHttp cHandle, const char *url);
...
const char *CkHttp_requestHeader(HCkHttp cHandle, const char *name);
...
const char *CkHttp_urlPath(HCkHttp cHandle, const char *url);
