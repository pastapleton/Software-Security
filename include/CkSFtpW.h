...
class CkSFtpW : public CkWideCharBase
{
    ...
    public:
	CkSFtpW();
	CkSFtpW(CkSFtp *p, bool bForDso);
	CkSFtpW(bool bForDso);
	virtual ~CkSFtpW();
	...
	CkSFtpProgress *get_EventCallbackObjectA(void) const;
	void put_EventCallbackObjectA(CkSFtpProgress *progress);
...
const wchar_t *fileCreateTimeStr(const wchar_t *w1,bool bFollowLinks,bool bIsHandle);
const wchar_t *fileGroup(const wchar_t *w1,bool bFollowLinks,bool bIsHandle);
const wchar_t *fileLastAccessStr(const wchar_t *w1,bool bFollowLinks,bool bIsHandle);
const wchar_t *fileLastModifiedStr(const wchar_t *w1,bool bFollowLinks,bool bIsHandle);
const wchar_t *fileOwner(const wchar_t *w1,bool bFollowLinks,bool bIsHandle);
const wchar_t *fileSizeStr(const wchar_t *w1,bool bFollowLinks,bool bIsHandle);
