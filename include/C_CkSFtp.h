...
const char *CkSFtp_fileCreateTimeStr(HCkSFtp cHandle, const char *pathOrHandle, BOOL bFollowLinks, BOOL bIsHandle);
const char *CkSFtp_fileGroup(HCkSFtp cHandle, const char *filePathOrHandle, BOOL bFollowLinks, BOOL bIsHandle);
const char *CkSFtp_fileLastAccessStr(HCkSFtp cHandle, const char *pathOrHandle, BOOL bFollowLinks, BOOL bIsHandle);
const char *CkSFtp_fileLastModifiedStr(HCkSFtp cHandle, const char *pathOrHandle, BOOL bFollowLinks, BOOL bIsHandle);
const char *CkSFtp_fileOwner(HCkSFtp cHandle, const char *filePathOrHandle, BOOL bFollowLinks, BOOL bIsHandle);
const char *CkSFtp_fileSizeStr(HCkSFtp cHandle, const char *filePathOrHandle, BOOL bFollowLinks, BOOL bIsHandle);
