...
HCkSshW CkSshW_Create2(BOOL bForDso);
...
const wchar_t *CkSshW__channelType(HCkSshW cHandle, int index);
...
const wchar_t *CkSshW__receivedText(HCkSshW cHandle, int channelNum, const wchar_t *charset);
const wchar_t *CkSshW__receivedTextS(HCkSshW cHandle, int channelNum, const wchar_t *substr, const wchar_t *charset);
