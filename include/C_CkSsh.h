...
const char *CkSsh_channelType(HCkSsh cHandle, int index);
...
const char *CkSsh_receivedText(HCkSsh cHandle, int channelNum, const char *charset);
const char *CkSsh_receivedTextS(HCkSsh cHandle, int channelNum, const char *substr, const char *charset);
