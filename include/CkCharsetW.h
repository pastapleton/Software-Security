...
class CkCharsetW : public CkWideCharBase
{
    ...
    public:
	CkCharsetW();
	CkCharsetW(CkCharset *p, bool bForDso);
	CkCharsetW(bool bForDso);
	virtual ~CkCharsetW();
...
const wchar_t *htmlCharset(const CkByteData &htmlData);
const wchar_t *htmlDecodeToStr(const wchar_t *w1);
const wchar_t *htmlFileCharset(const wchar_t *w1);
