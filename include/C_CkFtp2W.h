...
HCkFtp2W CkFtp2W_Create2(BOOL bForDso);
...
int CkFtp2W_getDownloadRate(HCkFtp2W cHandle);
...
void CkFtp2W_getLastReply(HCkFtp2W cHandle, HCkStringW retval);
...
int CkFtp2W_getUploadRate(HCkFtp2W cHandle);
...
BOOL CkFtp2W_GetFilename(HCkFtp2W cHandle, int index, HCkStringW outStr);
...
int CkFtp2W_GetSizeByName(HCkFtp2W cHandle, const wchar_t *filname);
__int64 CkFtp2W_GetSizeByName64(HCkFtp2W cHandle, const wchar_t *filename);
BOOL CkFtp2W_GetSizeStr(HCkFtp2W cHandle, int index, HCkStringW outStr);
...
const wchar_t *CkFtp2W__createTimeByNameStr(HCkFtp2W cHandle, const wchar_t *filename);
const wchar_t *CkFtp2W__createTimeStr(HCkFtp2W cHandle, int index);
const wchar_t *CkFtp2W__currentRemoteDir(HCkFtp2W cHandle);
...
const wchar_t *CkFtp2W__filename(HCkFtp2W cHandle, int index);
...
const wchar_t *CkFtp2W__getFilename(HCkFtp2W cHandle, int index);
...
const wchar_t *CkFtp2W__getSizeStr(HCkFtp2W cHandle, int index);
...
const wchar_t *CkFtp2W__lastAccessTimeByNameStr(HCkFtp2W cHandle, const wchar_t *filename);
const wchar_t *CkFtp2W__lastAccessTimeStr(HCkFtp2W cHandle, int index);
...
const wchar_t *CkFtp2W__lastModifiedTimeByNameStr(HCkFtp2W cHandle, const wchar_t *filename);
const wchar_t *CkFtp2W__lastModifiedTimeStr(HCkFtp2W cHandle, int index);
const wchar_t *CkFtp2W__lastReply(HCkFtp2W cHandle);
...
const wchar_t *CkFtp2W__remoteFileTextC(HCkFtp2W cHandle, const wchar_t *remoteFilename, const wchar_t *charset);
const wchar_t *CkFtp2W__remoteFileTextData(HCkFtp2W cHandle, const wchar_t *remoteFilename);
const wchar_t *CkFtp2W__sendCommand(HCkFtp2W cHandle, const wchar_t *cmd);
const wchar_t *CkFtp2W__sessionLog(HCkFtp2W cHandle);
const wchar_t *CkFtp2W__sizeStr(HCkFtp2W cHandle, int index);
const wchar_t *CkFtp2W__sizeStrByName(HCkFtp2W cHandle, const wchar_t *filename);
...
const wchar_t *CkFtp2W__textDirListing(HCkFtp2W cHandle, const wchar_t *pattern);
const wchar_t *CkFtp2W__username(HCkFtp2W cHandle);
const wchar_t *CkFtp2W__version(HCkFtp2W cHandle);
const wchar_t *CkFtp2W__xmlDirListing(HCkFtp2W cHandle, const wchar_t *pattern);
#endif
