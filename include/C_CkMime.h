...
const char *CkMime_headerField(HCkMime cHandle, const char *name);
const char *CkMime_headerFieldAttribute(HCkMime cHandle, const char *name, const char *attrName);
const char *CkMime_headerFieldName(HCkMime cHandle, int index);
const char *CkMime_headerFieldValue(HCkMime cHandle, int index);
...
const char *CkMime_signatureSigningTimeStr(HCkMime cHandle, int index);
