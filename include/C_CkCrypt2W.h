...
HCkCrypt2W CkCrypt2W_Create2(BOOL bForDso);
...
const wchar_t *CkCrypt2W__encodedIV(HCkCrypt2W cHandle, const wchar_t *encoding);
const wchar_t *CkCrypt2W__encodedKey(HCkCrypt2W cHandle, const wchar_t *encoding);
const wchar_t *CkCrypt2W__encodedSalt(HCkCrypt2W cHandle, const wchar_t *encoding);
...
const wchar_t *CkCrypt2W__signatureSigningTimeStr(HCkCrypt2W cHandle, int index);
