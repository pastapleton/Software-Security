...
class CkSocketW : public CkWideCharBase
{
    ...
    public:
	CkSocketW();
	CkSocketW(CkSocket *p, bool bForDso);
	CkSocketW(bool bForDso);
	virtual ~CkSocketW();
	...
	CkSocketProgress *get_EventCallbackObjectA(void) const;
	void put_EventCallbackObjectA(CkSocketProgress *progress);
...
void put_DebugConnectDelayMs(int propVal);
int get_DebugDnsDelayMs(void);
void put_DebugDnsDelayMs(int propVal);
...
void put_MaxReadIdleMs(int propVal);
int get_MaxSendIdleMs(void);
void put_MaxSendIdleMs(int propVal);
...
void put_ReceivePacketSize(int propVal);
...
void put_SendPacketSize(int propVal);
...
bool ReceiveBytesENC(const wchar_t *w1,CkString &outStr);
...
bool ReceiveNBytesENC(unsigned long numBytes,const wchar_t *w1,CkString &outStr);
...
bool SendBytesENC(const wchar_t *w1,const wchar_t *w2);
...
const wchar_t *receiveBytesENC(const wchar_t *w1);
const wchar_t *receiveNBytesENC(unsigned long numBytes,const wchar_t *w1);
