...
HCkDsaW CkDsaW_Create2(BOOL bForDso);
...
const wchar_t *CkDsaW__encodedHash(HCkDsaW cHandle, const wchar_t *encoding);
const wchar_t *CkDsaW__encodedSignature(HCkDsaW cHandle, const wchar_t *encoding);
