...
const char *CkCgi_env(HCkCgi cHandle, const char *varName);
...
const char *CkCgi_param(HCkCgi cHandle, const char *paramName);
const char *CkCgi_paramName(HCkCgi cHandle, int index);
const char *CkCgi_paramValue(HCkCgi cHandle, int index);
const char *CkCgi_uploadDir(HCkCgi cHandle);
const char *CkCgi_uploadFilename(HCkCgi cHandle, int index);
