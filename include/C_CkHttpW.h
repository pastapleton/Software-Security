...
HCkHttpW CkHttpW_Create2(BOOL bForDso);
...
const wchar_t *CkHttpW__cacheRoot(HCkHttpW cHandle, int index);
...
const wchar_t *CkHttpW__cookieXml(HCkHttpW cHandle, const wchar_t *domain);
const wchar_t *CkHttpW__debugLogFilePath(HCkHttpW cHandle);
const wchar_t *CkHttpW__domain(HCkHttpW cHandle, const wchar_t *url);
...
const wchar_t *CkHttpW__requestHeader(HCkHttpW cHandle, const wchar_t *name);
...
const wchar_t *CkHttpW__urlPath(HCkHttpW cHandle, const wchar_t *url);
