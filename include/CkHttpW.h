...
class CkHttpW : public CkWideCharBase
{
    ...
    public:
	CkHttpW();
	CkHttpW(CkHttp *p, bool bForDso);
	CkHttpW(bool bForDso);
	virtual ~CkHttpW();
	...
	CkHttpProgress *get_EventCallbackObjectA(void) const;
	void put_EventCallbackObjectA(CkHttpProgress *progress);
...
void put_DefaultFreshPeriod(int propVal);
...
void put_FreshnessAlgorithm(int propVal);
...
void put_MaxConnections(int propVal);
int get_MaxFreshPeriod(void);
void put_MaxFreshPeriod(int propVal);
...
void put_MinFreshPeriod(int propVal);
...
void put_NumCacheLevels(int propVal);
...
CkHttpResponseW *PostJson2(const wchar_t *w1,const wchar_t *w2,const wchar_t *w3);
...
CkHttpResponseW *SynchronousRequest(const wchar_t *w1,int port,bool ssl,const CkHttpRequestW &req);
...
const wchar_t *cookieXml(const wchar_t *w1);
const wchar_t *debugLogFilePath(void);
const wchar_t *domain(const wchar_t *w1);
...
const wchar_t *requestHeader(const wchar_t *w1);
...
const wchar_t *urlPath(const wchar_t *w1);
