...
const char *CkMht_cacheRoot(HCkMht cHandle, int index);
...
const char *CkMht_eML(HCkMht cHandle, const char *url);
...
const char *CkMht_mHT(HCkMht cHandle, const char *url);
