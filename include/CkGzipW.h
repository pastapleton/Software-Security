...
class CkGzipW : public CkWideCharBase
{
    ...
    public:
	CkGzipW();
	CkGzipW(CkGzip *p, bool bForDso);
	CkGzipW(bool bForDso);
	virtual ~CkGzipW();
	...
	CkGzipProgress *get_EventCallbackObjectA(void) const;
	void put_EventCallbackObjectA(CkGzipProgress *progress);
