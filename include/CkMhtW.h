...
class CkMhtW : public CkWideCharBase
{
	...
	CkMhtProgress *get_EventCallbackObjectA(void) const;
	void put_EventCallbackObjectA(CkMhtProgress *progress);
...
const wchar_t *eML(const wchar_t *w1);
...
const wchar_t *mHT(const wchar_t *w1);
