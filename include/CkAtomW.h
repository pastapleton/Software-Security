...
class CkAtomW : public CkWideCharBase
{
    ...
    public:
	CkAtomW();
	CkAtomW(CkAtom *p, bool bForDso);
	CkAtomW(bool bForDso);
	virtual ~CkAtomW();
	...
	CkAtomProgress *get_EventCallbackObjectA(void) const;
	void put_EventCallbackObjectA(CkAtomProgress *progress);
...
const wchar_t *element(const wchar_t *w1,int index);
const wchar_t *elementAttr(const wchar_t *w1,int index,const wchar_t *w2);
const wchar_t *elementDateStr(const wchar_t *w1,int index);
...
const wchar_t *linkHref(const wchar_t *w1);
const wchar_t *personInfo(const wchar_t *w1,int index,const wchar_t *w2);
const wchar_t *toXmlString(void);
const wchar_t *topAttr(const wchar_t *w1);
